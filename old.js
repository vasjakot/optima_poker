...
/*switch (prog){
	...
	//pair
		...
		/*if (force1 == force2){
			var tempM1     = new Array();
			tempM1         = cheked(nom1, 2, 14);
			tempM1[force1] = 0;
			var tempM2     = new Array();
			tempM2         = cheked(nom2, 2, 14);
			tempM1[force2] = 0;
			st             = compareMas(tempM1, tempM2);
		}*//*
	case 2:
	//2 pair
		if (force1[1]<force2[1])
...
var temp;
var teks;
var listBlank  = new Array();
var listCards  = new Array();
var listStreet = new Array();
var h = 0;
var ssv;
for(ssv=0;ssv<=len; ssv++){
	temp      = mainMas[ssv];
	listBlank = genMas(temp,5);
	teks      = ssv+5;
	listCards = mainMas.slice(ssv,teks);
	if (compareSet(listBlank,listCards,5) == 1){
			listStreet[h] = new Array();
			listStreet[h] = listBlank;
			h++;
		}
	}
return listStreet;
...
function cardNomToString(nomin, mast){
var str = "";
return 0;
}

// до пар
function pare_dif(nom, mas){
